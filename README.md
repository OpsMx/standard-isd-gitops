...
5. **Update Values.yaml as required**, specifically: At at **minimum** the ISD URL and gitops-repo details in spinnaker.gitopsHalyard section must be updated. Full values.yaml is available at: [[https://github.com/OpsMx/enterprise-spinnaker/tree/master/charts/oes](https://github.com/OpsMx/enterprise-spinnaker/tree/v3.12/charts/oes)](https://github.com/OpsMx/enterprise-spinnaker/tree/v3.12/charts/oes)
